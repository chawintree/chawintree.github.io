...
<sub>Side note - two points which I wanted to raise but didn't fit in nicely:</sub>

<sub>- Firstly, a loose idea of opt-in advertising. For instance, a single page in a newspaper in which businesses can market themselves, with all businesses limited to the same size of space. However, the page is at the back of the newspaper so I can choose not to open it. Similarly, adverts that are played at the end of a film; the key point to this is that it is *my choice* as to whether I experience them.</sub>

<sub>- Secondly, influencers. I'd like to speak more about this in the future, but the existence of human adverts troubles me a lot. I worry about not only the irreparable damage it is doing to societal engagement, but also to the "influencers" themselves as humans.</sub>
